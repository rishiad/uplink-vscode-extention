...
import SSHConfig, { Directive, Line, LineType, Section, parse as parseSSHConfig } from '@jeanp413/ssh-config';
...
async function parseSSHConfigFromFile(filePath: string, userConfig: boolean) {
    ...
    const config = normalizeSSHConfig(parseSSHConfig(content));
